@foreach ($newArrivalsProducts as $key =>$v)
        ...
        <figure class="product-media">
            ...
            @endif
                        <div class="product-action-vertical">
                            <a href="#" onClick="return false;" data-id_product="{{$v->id}}" style="font-family: Be VietNam" class="btn-product-icon btn-wishlist btn-expandable btn-wishlist-new-arrival" title="Wishlist"><span>Thêm Danh Sách Yêu Thích</span></a>
