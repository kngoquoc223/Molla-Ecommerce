<main class="main">
    <div class="page-header text-center" style="background-image: url('/frontend/assets/images/page-header-bg.jpg')">
        <div class="container-fluid">
            <h1 style="text-transform: uppercase;font-family: Be VietNam" class="page-title">Nhóm Mới phát hành<span>Shop</span></h1>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li style="font-family: Be VietNam" class="breadcrumb-item active" aria-current="page">Mới phát hành</li>
            </ol>
        </div><!-- End .container-fluid -->
