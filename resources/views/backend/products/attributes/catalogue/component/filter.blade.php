<form action="{{route('attribute.catalogue.index')}}">
    <div class="d-flex">
        ...
        <div class="p-2">
            <span class="input-group-btn">
                <a href="{{route('attribute.catalogue.index')}}" class="btn btn-primary mb0 btn-m">Refresh<span class="fas fa-sync-alt"></span></a>
            </span>    
        </div>
        <div class="p-2">
            <a href="{{route('attribute.catalogue.create')}}" class="btn btn-danger mb0 btn-m" ><i class="fa fa-plus mr3">Thêm mới thuộc tính</i></a>
        </div>
      </div>
</form>