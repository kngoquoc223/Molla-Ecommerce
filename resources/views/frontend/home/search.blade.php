<main class="main">
    <div class="page-header text-center" style="background-image: url('/frontend/assets/images/page-header-bg.jpg')">
        <div class="container-fluid">
            <h1 class="page-title">Tìm kiếm<span>Shop</span></h1>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li style="font-family: Be VietNam" class="breadcrumb-item active" aria-current="page">Tìm kiếm</li>
            </ol>
        </div><!-- End .container-fluid -->
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="toolbox">
                ...
                <div class="toolbox-center">
                    <div class="toolbox-info">
                        Kết quả tìm kiếm cho <span>"{{ Request::get('keywords') }}"</span>
            ...
            <div class="products">
                ...
                @else
                <p style="font-family: Be VietNam;font-size: 1.6rem" class="text-center">Không tìm thấy nội dung bạn yêu cầu</p>
                <br>
                <p style="font-family: Be VietNam;font-size: 1.6rem" class="text-center">Không tìm thấy <b>"{{ Request::get('keywords') }}"</b>. Vui lòng kiểm tra chính tả, sử dụng các từ tổng quát hơn và thử lại!</p>
                @endif
            </div><!-- End .products -->
