<form action="{{route('slider.index')}}">
    <div class="d-flex">
        ...
        <div class="p-2">
            <span class="input-group-btn">
                <a href="{{route('slider.index')}}" class="btn btn-primary mb0 btn-m">Refresh<span class="fas fa-sync-alt"></span></a>
            </span>    
        </div>
        <div class="p-2">
            <a href="{{route('slider.create')}}" class="btn btn-danger mb0 btn-m" ><i class="fa fa-plus mr3">Thêm mới Slider</i></a>
        </div>
      </div>
</form>