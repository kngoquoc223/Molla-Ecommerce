<main class="main">
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li style="font-family: Be VietNam" class="breadcrumb-item active" aria-current="page">404</li>
            </ol>
        </div><!-- End .container -->
    ...
    <div class="error-content text-center" style="background-image: url(/frontend/assets/images/backgrounds/error-bg.jpg)">
        <div class="container">
            <h1 class="error-title" style="font-family: Be VietNam">404</h1><!-- End .error-title -->
            <p style="font-family: Be VietNam">Không tìm thấy trang.</p>
